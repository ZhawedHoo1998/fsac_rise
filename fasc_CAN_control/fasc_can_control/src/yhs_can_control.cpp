			...
			for(int j=0;j<1;j++)
			{
				...
				switch (recv_frames_[0].can_id)
				{
					...
					case 0x98C4D7EF:
					{
						...
						vehicle_msg.lr_wheel_fb_velocity = (float)((short)(recv_frames_[0].data[1] << 8 | recv_frames_[0].data[0])) / 1000;
						unsigned char crc = recv_frames_[0].data[0] ^ recv_frames_[0].data[1] ^ recv_frames_[0].data[2] ^ recv_frames_[0].data[3] ^ recv_frames_[0].data[4] ^ recv_frames_[0].data[5] ^ recv_frames_[0].data[6];
						if(crc != recv_frames_[0].data[7])
						{
							ROS_ERROR("vehicle_msg.lr_wheel_fb_velocity received error!");
						}
						else{
							count_vehicle_status++;
						}
					...
					case 0x98C4D8EF:
					{
						vehicle_msg.rr_wheel_fb_velocity = (float)((short)(recv_frames_[0].data[1] << 8 | recv_frames_[0].data[0])) / 1000;
						unsigned char crc = recv_frames_[0].data[0] ^ recv_frames_[0].data[1] ^ recv_frames_[0].data[2] ^ recv_frames_[0].data[3] ^ recv_frames_[0].data[4] ^ recv_frames_[0].data[5] ^ recv_frames_[0].data[6];
						if(crc != recv_frames_[0].data[7])
						{
							ROS_ERROR("vehicle_msg.rr_wheel_fb_velocity received error!");
						}
						else{
							count_vehicle_status++;
						}
					...
					case 0x98C4E1EF:
					{
						...
						vehicle_msg.bms_Infor_voltage = (float)((unsigned short)(recv_frames_[0].data[1] << 8 | recv_frames_[0].data[0])) / 100;

						vehicle_msg.bms_Infor_current = (float)((short)(recv_frames_[0].data[3] << 8 | recv_frames_[0].data[2])) / 100;

						vehicle_msg.bms_Infor_remaining_capacity = (float)((unsigned short)(recv_frames_[0].data[5] << 8 | recv_frames_[0].data[4])) / 100;

						unsigned char crc = recv_frames_[0].data[0] ^ recv_frames_[0].data[1] ^ recv_frames_[0].data[2] ^ recv_frames_[0].data[3] ^ recv_frames_[0].data[4] ^ recv_frames_[0].data[5] ^ recv_frames_[0].data[6];

						if(crc != recv_frames_[0].data[7])
						{
							ROS_ERROR("vehicle_msg.bms received error!");
						}
						else{
							count_vehicle_status++;
						}
