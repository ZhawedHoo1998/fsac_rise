...
# ------------------------------------------------------------------------------------
    ...
    # bridge=CvBridge()
    rospy.init_node('left_camera_node', anonymous=True)
    image_pub=rospy.Publisher('/camera/image_color_left', Image, queue_size = 1)
...
# ------------------------------------------------------------------------------------
    ...
    for i in range(0, deviceList.nDeviceNum):
        ...
        if mvcc_dev_info.nTLayerType == MV_GIGE_DEVICE:
            ...
            if(strSerialNumber=="K11984315"):
                print("left camera serial number: %s" % strSerialNumber)
            else:
                print("right camera serial number: %s" % strSerialNumber)
