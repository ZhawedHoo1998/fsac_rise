...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        :  current_dir +'/model_data/best.pth',
        "classes_path"      :  current_dir +'/model_data/voc_classes.txt',
        #---------------------------------------------------------------------#
        #   anchors_path代表先验框对应的txt文件，一般不修改。
        #   anchors_mask用于帮助代码找到对应的先验框，一般不修改。
        #---------------------------------------------------------------------#
        "anchors_path"      : current_dir + '/model_data/yolo_anchors.txt',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font='/home/advan/yhs_ws/perception/src/yolov4_tiny_track/model_data/simhei.ttf', size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
        ...
        for i, c in list(enumerate(top_label)):
            ...
            bbox.append([top,left,bottom,right,score,])
            class_color.append(predicted_class)
